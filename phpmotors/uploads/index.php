...
switch ($action) {
    case 'upload':
        ...
        if ($imageCheck) {
            $message = '<p class="msg">An image by that name already exists.</p>';
        } elseif (empty($invId) || empty($imgName)) {
            $message = '<p class="msg">You must select a vehicle and image file for the vehicle.</p>';
        } else {
            ...
            if ($result) {
                $message = '<p class="msg">The upload succeeded.</p>';
            } else {
                $message = '<p class="err-msg">Sorry, the upload failed.</p>';
            }
        }
    ...
    case 'delete':
        ...
        if ($remove) {
            $message = "<p class='msg para'>$filename was successfully deleted.</p>";
        } else {
            $message = "<p class='msg para'>$filename was NOT deleted.</p>";
        }
