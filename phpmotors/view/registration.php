    ...
    <div id="wrapper">
        ...
        <main class="register-main">
            ...
            <form method="post" action="/phpmotors/accounts/index.php" class="register">
                ...
                <input type="password" id="clientPassword" name="clientPassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*\W).{8,}" title="Passwords must be at least 8 characters long. Contains at least 1 uppercase character, 1 number, and 1 special character.">
